...
tag to tell browsers to render the gaps.
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>In a cocktail shaker, combine 2 oz whiskey, 3/4 oz fresh lemon juice, and 1/2 oz simple syrup. If you prefer a frothy texture, add 1/2 oz egg white.</li>
                    <li>Add ice to the shaker. Shake vigorously for about 15 seconds to chill the mixture and, if using egg white, to create a frothy texture.</li>
                    <li>Strain the mixture into an old-fashioned glass filled with ice. Garnish with a maraschino cherry and a lemon slice. Enjoy your Whiskey Sour!</li>
                </ol>
                ...
                <ul id="wd-your-books">
                    ...
                    <li>The Scarlet</li>
                    <li>The Republic</li>
                    <li>The History of Western Philosophy</li>
                </ul>
            </div>
            <div id="wd-tables">
                <h4>Table Tag</h4>
